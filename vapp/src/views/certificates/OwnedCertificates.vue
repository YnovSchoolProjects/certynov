        ...
        <md-table v-model="searched" md-sort="organization" md-sort-order="asc" md-card>
            <md-table-toolbar>
                <div class="md-toolbar-section-start">
                    <h1 class="md-title">Owned Certificates</h1>
                </div>
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item : certificate }">
                <md-table-cell md-label="issuer">{{ certificate.issuer }}</md-table-cell>
...
<script>
    ...
    export default {
        ...
        mounted() {
            const certs = this.$store.getters['eth/certs/getOwnedCertificates'];
            this.searched = certs;
